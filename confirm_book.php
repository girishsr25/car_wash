...
.signin {
  ...
  text-align: center;
    ...
    <form action="booking_validate.php" method="POST">
        ...
        <input type="text" placeholder="Enter Place" name="place" id="place" value="<?php echo ( isset ( $rows ) ? $rows[0] : '' ); ?>"  required>
        ...
        <label for="type_service"><b>Types of Service</b></label><br>
          ...
          <button type="submit" class="registerbtn">Confirm Booking</button>
